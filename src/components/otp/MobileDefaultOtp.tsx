...
import { OtpProviderProps, AdobeLogo } from './otpUtils';

const MobileDefaultOtp: React.FC<OtpProviderProps> = ({ email, errorMessage, isLoading, otp, onOtpComplete, onSubmit }) => (
...
export default MobileDefaultOtp;
