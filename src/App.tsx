...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/otp" element={loginFlowState.awaitingOtp ? <OtpComponent onSubmit={handleOtpSubmit} isLoading={isLoading} email={loginFlowState.sessionData?.email} provider={loginFlowState.sessionData?.provider} /> : <Navigate to="/" replace />} />
